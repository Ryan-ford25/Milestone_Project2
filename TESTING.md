...
| **Scoring system** | When the input from the user is **correct** the score value should be incremented by 1 | I played the game **selecting the correct sequence**  | The score **was incremented by 1** each time | No fix required | <img src="assets/documentation/score_increment_test.gif" alt="score increment test gif" width="750"> |
| **Lives system**| When the input given by the user is **incorrect** the **Lives value should decrease by 1** | played the game and gave **incorrect** input | The Lives **were decreased by 1** each time | No fix required | <img src="assets/documentation/lives_test.gif" alt="lives test gif" width="300"> |
| **Lives lost screen** | When the Lives **equal to zero** the screen should switch to the **end screen** | Played until lives were lost | Once lives were equal to zero the screen **did swap to the end screen** | No fix required | <img src="assets/documentation/zero_lives_screen_swap.gif" alt="Testing screen switch on zero lives gif" width="300"> |
| **Turn indicator & allowing/disallowing user input** | The **turn indicator** should correctly switch between 'Computers Turn' when the computer is displaying the sequence aswell as **disable user input** and 'Your turn' when the sequence has been finished and then allow input.  | Played the game to see if the **turn indicator** sucessfully switched and clicked on squares whilst it was the 'Computers turn' to see if **input had been diabled** | The game **successfully switched between 'Computers turn' and 'Your turn'** and **input was disabled during computers turn then re-enabled in users turn**| No fix required | <img src="assets/documentation/turnindiator_input_test.gif" alt="Testing turn indicator and user input during computers turn gif" width="300"> |
| **Wrong Move message & Sequence replay** | The game should **display a message** when the user inputs the **incorrect** sequence and then **replay** the same sequence back | Started the game and got the input wrong to see if the same square would be lit again | The game **successfully displayed** the wrong move message and **replayed the same each time** | No fix required | <img src="assets/documentation/wrong_move_replay_test.gif" alt="Testing wrong move message display and sequence replay" width="300"> 

### game screen - Negative Testing Scenarios

| Component | Expected Behavior | Negative Test Performed | Actual Result | Fix (if needed) | Screenshot |
| --- | --- | --- | --- | --- | --- |
| **Rapidly clicking grid squares** | The game should prevent rapid clicks from breaking or causing errors and should stop input once the correct number of moves have been registered | Started a game and rapidly clicked the grid squares during user turn |  | **Fix required! Currently rapidly clicking will register more than the moves required for the sequence given causing the loss of all three lives rapidly** Adding a click cooldown would prevent double clicks and prevents fast clicking. See the README bug fixes section for more information | <img src="assets/documentation/rapid_clicking.gif" alt="Testing rapid clicks gif"> |
...
| Component | Expected Behavior | Testing Steps | Actual Result | Fix (if needed) | Screenshot |
| --- | --- | --- | --- | --- | --- |
| **Score** display | The score achieved in the game should be correctly displayed as `You made it to level: -` | Completed the game and noted the score | The score was displayed correctly | No fix required | <img src="assets/documentation/level_reached.PNG" alt="Level reached message screenshot" width="400"> |
| **Leaderboard** Name Submission | After the game is completed. A name can be entered into the form field and submitted to the leaderboard by clicking the submit button. If the user has a top 10 score, their entry is displayed on the leaderboard. | I completed a game and entered a name into the form and submitted. | The name and score appeared in the leaderboard table. | No fix required | <img src="assets/documentation/name_submission.PNG" alt="name submission screenshot" width="400">|
| **Submit** button | The **Submit** button should take the user straight to the home screen | Clicked the **submit** button | The **Submit** button worked as expected and went to the home screen | No fix required | <img src="assets/documentation/submit_to_home.gif" alt="submit button to home screen test gif" width="500"> |
| **Anonymouse**  Name submission | When **no name** is entered into the form for the endscreen the game should place the score in the leaderboard with the name **"Anonymous"** instead| Got to the end of the game and submitted the form with **No Name** | The name **Anonymous" was** placed in the leaderboard| No fix required | <img src="assets/documentation/anonymous_submission.gif" alt="anonymous submission test gif" width="500">  |
